...
public class MusicActivity extends Activity {
    ...
    private ArrayList<Map<String, Object>> getData() {
        ...
        map = new HashMap<>();
        map.put("image", R.drawable.music_img1);
        map.put("title","陪我长大");
        ...
        map = new HashMap<>();
        map.put("image",R.drawable.music_img2);
        map.put("title","身骑白马");
        map.put("author","徐佳莹");
        map.put("rightImg",R.drawable.music_img_right);
        list.add(map);
        ...
        map = new HashMap<>();
        map.put("image",R.drawable.music_img3);
        map.put("title","倒数");
        ...
        map = new HashMap<>();
        map.put("image",R.drawable.music_img4);
        map.put("title","某某");
        map.put("author","孟凡明");
        map.put("rightImg",R.drawable.music_img_right);
        list.add(map);
        ...
        map = new HashMap<>();
        map.put("image",R.drawable.music_img5);
        map.put("title","爱殇");
