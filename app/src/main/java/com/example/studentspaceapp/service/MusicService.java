...
import com.example.studentspaceapp.activity.ShowMusicActivity;
import com.example.studentspaceapp.model.MusicData;
...
public class MusicService extends Service implements MediaPlayer.OnCompletionListener {
    ...
    private void initMusicDatas(Intent intent) {
        ...
        List<MusicData> musicDatas = (List<MusicData>) intent.getSerializableExtra(ShowMusicActivity.PARAM_MUSIC_LIST);
